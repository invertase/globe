...
During private preview the maximum duration is currently **5 seconds**. We may increase this based on feedback and also allow higher limits for paid plans in the future.
