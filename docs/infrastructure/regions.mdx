...
The Globe edge network is located in some [300 cities in 100+ countries](https://www.cloudflare.com/en-gb/network/) and is powered by [Cloudflare’s network][cloudflare-network-url] - which is milliseconds away from virtually every Internet user on the globe.
...
[cloudflare-network-url]: https://www.cloudflare.com/network/
