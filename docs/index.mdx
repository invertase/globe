...
<Info>
  **Globe is shutting down.** If you are migrating your applications to another platform, see the [Platform Migration Guide](/migration) for deployments, custom domains, Globe DB, and Globe KV.
</Info>
