...
- [GitHub Integration][github-integration-url]: Globe integrates with your existing CI/CD pipeline to automatically deploy your applications on every push to your Git repository.
