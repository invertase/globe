...
**Account Deletion**
You may delete your account at any time through the account settings provided. Deleting your account will permanently delete your organisation and all associated data, including projects, deployments, configuration, and user access.

Upon account deletion, we will begin removing all stored user data from our active systems.

Please note that due to the nature of our technical infrastructure, some data may temporarily remain in cached or backup systems for a limited period. This retention is technical in nature and is not an attempt to retain your data beyond the requested deletion. Any such data is not accessible to users and is not used for any purpose other than completing the deletion process or maintaining system integrity.

This data will be deleted or irreversibly anonymised in line with our standard data retention policies and our Privacy Policy as soon as reasonably possible following account deletion.
...
We are committed to providing a stable and high-performance service for all users. Each tier includes a defined allocation of resources (e.g., bandwidth, compute capacity, memory). These limits help guide appropriate use but are not automatically enforced through strict caps. Instead, we expect users to operate within reasonable usage levels based on their tier.

The Fair Use Policy exists to maintain service quality and prevent usage that negatively impacts other users.

**Resource Usage and Monitoring**

Users can track their resource usage through the dashboard, which provides real-time insights into key metrics. The specific metrics available may change over time as we improve and expand our monitoring capabilities.

**Excessive or Disruptive Usage**

To maintain overall system performance, we may intervene if usage patterns:

- Consistently exceed what is reasonable for the tier.
- Negatively affect platform stability or impact other users.
- Indicate misuse, such as excessive background processing or unauthorised resource-intensive activities.

If intervention is required, we will notify you and may request that you reduce usage or consider alternative options.

**Enforcement Actions**

We may take action against accounts engaging in excessive or disruptive usage, which may include:

- Throttling: Slowing down resource access to mitigate impact.
- Pausing: Temporarily disabling specific deployments or processes.
- Suspension: Temporarily restricting access to your account, as detailed in the Account Suspension section.

Repeated or extreme violations may lead to termination of your account, as outlined in the Termination section.
...
We welcome your feedback on our Services, including but not exclusive to bug reports, suggestions for improvements, and general comments. You can find support for Globe via Discord [here](https://invertase.link/globe-discord) or make suggestions via Canny.io [here](https://invertase.canny.io/globe).
...
#### 10. End User Licence Agreement (EULA)
...
General Support is available across all products and is primarily community-driven. You can ask questions and share solutions through the Globe [Discord](https://invertase.link/globe-discord) community or access FAQ sections and self-service documentation for common issues.
...
* Pro Tier users receive support via private [Discord](https://invertase.link/globe-discord) ticket options, with access to community resources. We prioritise issues using a private tiered ticketing system and aim to respond within 72 working hours. Urgent issues are handled with higher priority. Team members manage support, ensuring daily review and timely responses.  
