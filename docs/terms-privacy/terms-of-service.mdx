...
We welcome your feedback on our Services, including but not exclusive to bug reports, suggestions for improvements, and general comments. You can find support for Globe via Discord [here](https://invertase.link/globe-discord), make suggestions via Canny.io [here](https://invertase.canny.io/globe), or for Invertase wide support, head over to our Discord community [here](https://discord.gg/invertase). 
...
General Support is available across all products and is primarily community-driven. You can ask questions and share solutions through the Invertase Globe [Discord](https://invertase.link/globe-discord) community or Invertase [Discord](https://discord.gg/invertase) community, and access FAQ sections and self-service documentation for common issues.
