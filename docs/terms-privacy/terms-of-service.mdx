...
By using our Services, you agree to comply with these Terms of Service, including the [Acceptable Use Policy](#acceptable-use-policy-\(aup\)) and [End User Licence Agreement](#end-user-licence-agreement-\(eula\)), which are incorporated by reference into these Terms.  Please read these documents carefully. If you do not agree with them, please do not use our Services.
...
3. ## Communications and User Content {#communications-and-user-content}
...
4. ##  Acceptable Use Policy (AUP) {#acceptable-use-policy-(aup)}

When using our Services, you agree to adhere to the following acceptable use guidelines:

###### **Commercial Use on Free Tier** {#commercial-use-on-free-tier}
...
###### **Additional Prohibited Actions** {#additional-prohibited-actions}
...
5. ## Subscriptions and Payment plans {#subscriptions-and-payment-plans}
...
###### **Free and Paid Services** {#free-and-paid-services}
...
###### **Changes to Subscriptions and Payment** {#changes-to-subscriptions-and-payment}
...
7. ## Error Reporting and Feedback {#error-reporting-and-feedback}

We welcome your feedback on our Services, including but not exclusive to bug reports, suggestions for improvements, and general comments. You can find support for Globe [here](https://discord.gg/globe), make suggestions [here](https://invertase.canny.io/globe), or for Invertase wide support, head over to our Discord community [here](https://discord.gg/invertase). 
...
8. ## Links to Other Websites {#links-to-other-websites}
...
9. ## End User Licence Agreement (EULA) {#end-user-licence-agreement-(eula)}
...
10. ## Disclaimers and Limitations of Liability {#disclaimers-and-limitations-of-liability}
...
11. ## Changes to Service {#changes-to-service}
...
12. ##  Service Level Agreement (SLA) {#service-level-agreement-(sla)}
...
* Pro Tier users receive support via [Globe Discord](http://discord.gg/globe), with access to community resources. We prioritise issues using a private tiered ticketing system and aim to respond within 72 working hours. Urgent issues are handled with higher priority. Team members manage support, ensuring daily review and timely responses.  
* Enterprise Tier users receive priority support through email, [Globe Discord](http://discord.gg/globe), and a dedicated account manager. This includes proactive engagement, regular check-ins, and tailored solutions. We aim to respond within 72 working hours, prioritising urgent issues. Team members manage support, ensuring daily review and timely responses.


###### **Problem Resolution Commitment** {#problem-resolution-commitment}
...
13. ##  Amendments to Terms {#amendments-to-terms}
