...
We are committed to providing a reliable and high-performance service to all our users. As of the above effective date, Globe does not impose strict enforcement of resource limits. However, users are expected to operate within reasonable usage boundaries according to their subscribed plan.

**Resource Allocation and Monitoring**
Each subscription tier includes specific resource limits:

| **Resource**         | **Free Tier**            | **Pro Tier**             |
|----------------------|-------------------------|--------------------------|
| **Bandwidth**       | 5GB per month            | 50GB per month           |
| **Memory Allocation** | 256MB                   | 512MB                    |
| **Compute Duration** | 50GBh per month         | 500GBh per month         |
| **Cron Jobs**       | 1 per month (unlimited runs) | Unlimited              |

Users can track their resource consumption via the **dashboard**, which provides real-time analytics for bandwidth, requests, and caching.

**Excessive or Disruptive Usage**
While we do not actively enforce strict limits at this time, we reserve the right to **pause, throttle, or intervene** in deployments that:  

- Significantly exceed allocated resources for a prolonged period.  
- Cause performance degradation or instability for other users.  
- Are used in a manner that suggests abuse, excessive background processing, or unauthorized resource-intensive tasks.  

In such cases, we will make reasonable efforts to notify the user before taking corrective actions. Users may be asked to opt into a higher plan or adjust their usage to remain within acceptable limits.  
Repeated or extreme violations may result in temporary suspension as outlined in account suspension. 
