...
When you build a backend or full-stack app on Globe, you store data in **Globe Database**: serverless SQLite that works with Dart and Drift. Before you wire up endpoints or deploy, you need a clear picture of how your data is structured: which tables you have, how they link, and how that maps to the API and Flutter app you're building. This tutorial explains how to design that structure so your schema fits Globe DB and your deployment workflow.
...
- Optional: [Globe DB overview](/products/database) for product context

## Exploring Data Design for Globe Database

### 1. Why Data Design Matters on Globe
