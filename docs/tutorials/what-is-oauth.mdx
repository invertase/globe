...
This is the "dance" of OAuth. It's a carefully choreographed sequence of redirects that ensures security.
...
3. **The Redirect Back with a Code**: Google redirects the user back to your application. Appended to the URL is a temporary, one-time-use authorization code. This code is proof of consent.
...
5. **The Access Token is Granted**: Google verifies the code and the secret. If everything matches, it sends back a access token. This is the valet key.
