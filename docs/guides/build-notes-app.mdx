...
- **New to data design?** [Designing Data for Globe Database](/tutorials/designing-data-globe-database) covers tables, relationships, keys, and how they map to Drift and Globe DB before or after this guide.
