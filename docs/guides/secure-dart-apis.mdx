...
To ensure type safety, we will create a proper model for our users.
...
## Step 4: Link Your Project and Set Secrets

Before you can configure secrets, the project must exist on the Globe platform.

- **First, link your local directory to create the project on Globe:**
...
- **Implement Email Verification**: As a crucial next step, consider implementing an email verification flow to ensure users own the email addresses they register with.
