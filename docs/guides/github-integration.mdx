...
- View runtime logs and usage metrics under your custom domain or default URL in the [Monitoring](/core-concepts/usage) and [Logs](/core-concepts/logs) sections of your dashboard.
