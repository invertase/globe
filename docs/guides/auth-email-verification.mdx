...
description: Learn to send verification emails with Gmail and the mailer package to complete your authentication flow.
---
...
- The completed project from the guide: "[How to Secure Your Dart APIs on Globe](/guides/secure-dart-apis)".
