...
**Our Focus**: Organisation management features and navigation improvements.  
**Summary:** This release enhances organisation-level management features, improves dashboard navigation, and fixes several critical bugs.
...
| **UI Fixes**: Resolved several UI-related issues to improve user interface stability. | Improvement | 27/09/2024 |
