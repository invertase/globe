...
**Globe is the full-stack platform for Dart.**

We’re building the backend services, infrastructure, and tools that make it fast and simple to build production Flutter apps - without switching languages, configuring cloud platforms, or working around tools that weren’t built for Dart.
...
We’re committed to building Globe in the open, with clear priorities and real input from developers. Head over to our Canny board to share our roadmap and capture feedback in one place.
...
We check it regularly and use it to guide what we build next & every vote and comment helps us better understand what matters most to you.
