...
To get started, we're going to create a Flutter application and deploy Flutter Web to Globe. Globe has preconfigured build presets and it will be automatically detected and applied. If your application uses `build_runner`, then it will also automatically be detected and run during the building stage.
