...
To get started using Globe, ensure you have [logged in](/login) to your account and have access. Globe is currently in private alpha, so only select users have access.
...
To log in with your Globe account, run the following command:
...
- [Learn about managing your deployments](/docs/deployments)
