...
You can deploy your Dart applications to a Globally distributed network using the [framework of your choice](/frameworks). It is possible to deploy both Backend and Frontend applications as shown below. For simplicity, the CLI will be used for deploying the application.

<Tabs
  values={[
    { label: 'Backend Shelf Application', value: 'backend' },
    { label: 'Frontend Flutter Web Application', value: 'frontend' },
  ]}
>
