...
You can deploy your Dart applications to a Globally distributed network using the framework of your choice. It is possible to deploy both Backend and Frontend applications as shown below.
