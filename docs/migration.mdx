...
description: Migrate your Globe deployments, custom domains, databases, and KV data to other platforms with zero data loss and minimal downtime.
---
...
- [Part 1: Dart backend](#part-1-migrating-dart-backend-deployments)
- [Part 2: Flutter Web](#part-2-migrating-flutter-web-deployments)
- [Part 3: Jaspr](#part-3-migrating-jaspr-projects)
- [Part 4: Custom domain](#part-4-migrating-custom-domains)
- [Part 5: Globe DB](#part-5-migrating-globe-db-data)
- [Part 6: Globe KV](#part-6-migrating-globe-kv-data)
