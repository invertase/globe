...
description: Deploy Shelf server applications to Globe with zero configuration, automatic framework detection, and support for flexible Dart web server deployments.
---
