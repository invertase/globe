...
To deploy a Flutter Web Application, you can run the following command in the root of the project and Globe will automatically apply the correct preset and deploy your application. The build system will auto-detect `build_runner` if used and runs it during the building stage of the deployment.
