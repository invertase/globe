...
If a project already exists in Globe (for example, deployed via CLI), you can connect it to a GitHub repository as well. Browse to the project you want to connect and click on **Settings** -> **Git**.
