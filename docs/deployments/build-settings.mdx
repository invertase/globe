...
- [Dart Version](/deployments/deployment-settings#dart-version)
- [Root Directory](/deployments/deployment-settings#root-directory)
- [Framework Preset](/deployments/deployment-settings#framework-preset)
- [Build Command](/deployments/deployment-settings#build-command)
- [Entrypoint](/deployments/deployment-settings#entrypoint)
