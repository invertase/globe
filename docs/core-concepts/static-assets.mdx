...
- Static assets only work if **they are correctly configured**; Globe won't serve them unless they're detected or explicitly listed
...
- Stay organized and name assets clearly for easier maintenance
