...
export class ChatCompletion extends pb_1.Message {
  ...
  constructor(
    ...
    if (!Array.isArray(data) && typeof data == "object") {
      ...
      if (
        ...
        data.system_fingerprint != undefined
      ) {
  ...
  static fromObject(data: {
    ...
    if (data.choices != null) {
      message.choices = data.choices.map((item) =>
        ChatCompletion.Choices.fromObject(item)
      );
    }
    if (data.usage != null) {
  ...
  toObject() {
    ...
    if (this.choices != null) {
      data.choices = this.choices.map((item: ChatCompletion.Choices) =>
        item.toObject()
      );
    }
    if (this.usage != null) {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    ...
    if (this.object.length) writer.writeString(2, this.object);
    if (this.created != 0) writer.writeUint32(3, this.created);
    if (this.model.length) writer.writeString(4, this.model);
    if (this.choices.length)
      writer.writeRepeatedMessage(
        5,
        this.choices,
        (item: ChatCompletion.Choices) => item.serialize(writer)
      );
    if (this.has_usage)
      writer.writeMessage(6, this.usage, () => this.usage.serialize(writer));
    if (this.service_tier.length) writer.writeString(7, this.service_tier);
    ...
    while (reader.nextField()) {
      ...
      switch (reader.getFieldNumber()) {
        ...
        case 4:
          ...
          break;
        case 5:
          reader.readMessage(message.choices, () =>
            pb_1.Message.addToRepeatedWrapperField(
              message,
              5,
              ChatCompletion.Choices.deserialize(reader),
              ChatCompletion.Choices
            )
          );
          break;
        case 6:
          reader.readMessage(
            message.usage,
            () => (message.usage = ChatCompletion.Usage.deserialize(reader))
          );
          break;
        case 7:
...
export namespace ChatCompletion {
  export class Message extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.role.length) writer.writeString(1, this.role);
      if (this.content.length) writer.writeString(2, this.content);
      if (this.refusal.length) writer.writeString(3, this.refusal);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class Choices extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.finish_reason.length) writer.writeString(3, this.finish_reason);
      if (!w) return writer.getResultBuffer();
    }
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 2:
            reader.readMessage(
              message.message,
              () =>
                (message.message = ChatCompletion.Message.deserialize(reader))
            );
            break;
          case 3:
  ...
  export class Prompt_tokens_details extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.cached_tokens != 0) writer.writeUint32(1, this.cached_tokens);
      if (this.audio_tokens != 0) writer.writeUint32(2, this.audio_tokens);
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new Prompt_tokens_details();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  export class Completion_tokens_details extends pb_1.Message {
    ...
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == "object") {
        ...
        if (
          "accepted_prediction_tokens" in data &&
          data.accepted_prediction_tokens != undefined
        ) {
          this.accepted_prediction_tokens = data.accepted_prediction_tokens;
        }
        if (
          "rejected_prediction_tokens" in data &&
          data.rejected_prediction_tokens != undefined
        ) {
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new Completion_tokens_details();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  export class Usage extends pb_1.Message {
    ...
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == "object") {
        ...
        if (
          "prompt_tokens_details" in data &&
          data.prompt_tokens_details != undefined
        ) {
          this.prompt_tokens_details = data.prompt_tokens_details;
        }
        if (
          "completion_tokens_details" in data &&
          data.completion_tokens_details != undefined
        ) {
    ...
    get prompt_tokens_details() {
      return pb_1.Message.getWrapperField(
        this,
        ChatCompletion.Prompt_tokens_details,
        4
      ) as ChatCompletion.Prompt_tokens_details;
    }
    ...
    get completion_tokens_details() {
      return pb_1.Message.getWrapperField(
        this,
        ChatCompletion.Completion_tokens_details,
        5
      ) as ChatCompletion.Completion_tokens_details;
    }
    set completion_tokens_details(
      value: ChatCompletion.Completion_tokens_details
    ) {
    ...
    static fromObject(data: {
      ...
      completion_tokens?: number;
      total_tokens?: number;
      prompt_tokens_details?: ReturnType<
        typeof ChatCompletion.Prompt_tokens_details.prototype.toObject
      >;
      completion_tokens_details?: ReturnType<
        typeof ChatCompletion.Completion_tokens_details.prototype.toObject
      >;
    }): Usage {
      ...
      if (data.prompt_tokens_details != null) {
        message.prompt_tokens_details =
          ChatCompletion.Prompt_tokens_details.fromObject(
            data.prompt_tokens_details
          );
      }
      if (data.completion_tokens_details != null) {
        message.completion_tokens_details =
          ChatCompletion.Completion_tokens_details.fromObject(
    ...
    toObject() {
      ...
      if (this.completion_tokens_details != null) {
        data.completion_tokens_details =
          this.completion_tokens_details.toObject();
      }
      return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.prompt_tokens != 0) writer.writeUint32(1, this.prompt_tokens);
      if (this.completion_tokens != 0)
        writer.writeUint32(2, this.completion_tokens);
      if (this.total_tokens != 0) writer.writeUint32(3, this.total_tokens);
      if (this.has_prompt_tokens_details)
        writer.writeMessage(4, this.prompt_tokens_details, () =>
          this.prompt_tokens_details.serialize(writer)
        );
      if (this.has_completion_tokens_details)
        writer.writeMessage(5, this.completion_tokens_details, () =>
          this.completion_tokens_details.serialize(writer)
        );
      if (!w) return writer.getResultBuffer();
    }
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 4:
            reader.readMessage(
              ...
              () =>
                (message.prompt_tokens_details =
                  ChatCompletion.Prompt_tokens_details.deserialize(reader))
            );
            break;
          case 5:
            reader.readMessage(
              ...
              () =>
                (message.completion_tokens_details =
                  ChatCompletion.Completion_tokens_details.deserialize(reader))
            );
            break;
          default:
            reader.skipField();
...
export class ChatCompletionChunk extends pb_1.Message {
  ...
  static fromObject(data: {
    ...
    model?: string;
    choices?: ReturnType<
      typeof ChatCompletionChunk.Choices.prototype.toObject
    >[];
    usage?: ReturnType<typeof ChatCompletion.Usage.prototype.toObject>;
    service_tier?: string;
    system_fingerprint?: string;
    ...
    if (data.choices != null) {
      message.choices = data.choices.map((item) =>
        ChatCompletionChunk.Choices.fromObject(item)
      );
    }
    if (data.usage != null) {
      message.usage = ChatCompletion.Usage.fromObject(data.usage);
  ...
  toObject() {
    ...
    if (this.choices != null) {
      data.choices = this.choices.map((item: ChatCompletionChunk.Choices) =>
        item.toObject()
      );
    }
    if (this.usage != null) {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    ...
    if (this.choices.length)
      writer.writeRepeatedMessage(
        5,
        this.choices,
        (item: ChatCompletionChunk.Choices) => item.serialize(writer)
      );
    if (this.has_usage)
      writer.writeMessage(6, this.usage, () => this.usage.serialize(writer));
    if (this.service_tier.length) writer.writeString(7, this.service_tier);
  ...
  static deserialize(
    ...
    const reader =
        bytes instanceof pb_1.BinaryReader
          ? bytes
          : new pb_1.BinaryReader(bytes),
      message = new ChatCompletionChunk();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
        ...
        case 5:
          reader.readMessage(message.choices, () =>
            pb_1.Message.addToRepeatedWrapperField(
              message,
              5,
              ChatCompletionChunk.Choices.deserialize(reader),
              ChatCompletionChunk.Choices
            )
          );
          break;
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 2:
            reader.readMessage(
              message.delta,
              () => (message.delta = ChatCompletion.Message.deserialize(reader))
            );
            break;
          case 3:
            message.finish_reason = reader.readString();
...
export class OpenAIConfig extends pb_1.Message {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    const writer = w || new pb_1.BinaryWriter();
    if (this.base_url.length) writer.writeString(1, this.base_url);
    if (this.api_key.length) writer.writeString(2, this.api_key);
    if (this.name.length) writer.writeString(3, this.name);
    if (this.organization.length) writer.writeString(4, this.organization);
    if (this.project.length) writer.writeString(5, this.project);
